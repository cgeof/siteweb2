...
function myPlay(){
  var audio = new Audio("Human Fart - QuickSounds.com.mp3");
  audio.play();
}
    ...
    <div style={{ position: "absolute" }}>
      ...
      <div className="fg absol vh100 vw100">
        <div className="h80p w100p flex col aitcent jcsb">
          <h1 className=" bisou "> Chat j'ai pété fort </h1>
          ...
          <div style={{ height: "2%" }}> </div>
                    <img className="image1" src="cuicuipetit.png" id= "image"
                onClick={() => { myPlay(); bounceImage(document.getElementById("image")); }} />
          <div style={{ height: "7%" }}> </div>

        


          <p className="large"> <Link  to="/p4"
		      > Demander de l'aide à la copine du cuicui</Link>  </p>
          
          <marquee className=" bisou2">  Plus puissant, plus doux, plus bijou</marquee>
        </div>
